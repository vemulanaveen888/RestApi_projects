    ...
    <form id="form1" >
                ...
                <div class="container">
                    ...
                    <div class="col2 bg-light border-danger">
                        ...
                        <input type="text" required class="number" ng-model="ncard" maxlength="19" onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
                        
                        <label>Cardholder name</label>
                        <input type="text"  class="inputname" required > 
                       
                        <label>Expiry date</label>
                        <input type="text"  class="expire" required placeholder="MM / YYYY">
                        
                        <label>Security Number</label>
                         <input type="text" class="ccv" required  placeholder="CVC" maxlength="3" onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
                        
                        <a href="paid.html?empid=${map.empid }&pid=${map.pid }"  class="buy btn btn-primary">PAY</a>
