...
/**
 * Servlet implementation class ReportEmp
 */
public class ReportEmp extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			PdfPCell cell2 = new PdfPCell(new Paragraph("Employees Detailed Report"));
			...
			PdfPCell h1 = new PdfPCell(new Paragraph("empid"));
			...
			try {
				...
				while (rs.next()) {
					PdfPCell empid = new PdfPCell(new Paragraph(rs.getString("empid")));
					table2.addCell(empid);
					PdfPCell emp_name = new PdfPCell(new Paragraph(rs.getString("emp_name")));
					table2.addCell(emp_name);
					PdfPCell address = new PdfPCell(new Paragraph(rs.getString("address")));
					table2.addCell(address);
					PdfPCell dob = new PdfPCell(new Paragraph(rs.getString("dob")));
					System.out.println(rs.getString("dob"));
					table2.addCell(dob);
					PdfPCell phone = new PdfPCell(new Paragraph(rs.getString("phone")));
